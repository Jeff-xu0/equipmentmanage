    ...
    <div class="main-wrap" style="background-image: url('/static/images/20.jpg');height: auto;width: auto;">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-step">&gt;</span><span>新增器材</span></div>
        </div>
        ...
        <div class="result-wrap" style="margin-top: 100px">
            <div class="result-content">
                <form action="${APP_PATH}/service/addEquip" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th><i class="require-red">*</i>设备名称：</th>
                            <td>
                                <input class="common-text required" name="euqname" size="30" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>设备种类：</th>
                            <td><input class="common-text required" name="equkind"  size="30" /></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>设备类型：</th>
                            <td><input class="common-text required" name="type"  size="30" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${error==true}">
                                    <label class="require-red">添加失败，请返回或重试！</label>
                                </c:if>
                                <c:if test="${error==false}">
                                    <label class="require-red">添加成功！</label>
                                </c:if>
                            </td>
                        </tr>
                        </tbody></table>
