    ...
    <div class="main-wrap" style="background-image: url('/static/images/20.jpg');height: auto;width: auto;">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${APP_PATH}/service/selectivedamage" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="120">选择分类:</th>
                            <td>
                                <select name="selective" id="">
                                    <option value="damageid">报废编号</option>
                                    <option value="equid">设备编号</option>
                                </select>
                            </td>
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="关键字" name="keywords" value="" type="text">
                            </td>
            ...
            <form name="myform" id="myform" method="get">
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach items="${pageInfo.list}" var="damage">
                            <tr>
                                ...
                                <td>${damage.equid}</td>
                                <td>${damage.reason}</td>
<%--                                <td><fmt:formatDate value="${damage.repairtime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>--%>
                                        <td>${damage.handleman}</td>
                                <td>${damage.agreeman}</td>
                                <td>
                                    ${damage.way}
                                </td>
