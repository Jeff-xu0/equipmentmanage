...
<div class="container clearfix">
    <div class="sidebar-wrap" style="height: auto;">
    ...
    <div class="main-wrap" style="background-image: url('/static/images/20.jpg');height: auto;width: auto;">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${APP_PATH}/service/selectiveuser" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="请输入完整的关键词" name="keywords" value="" type="text">
                            </td>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach items="${pageInfo.list}" var="user">
                            <tr>
                                ...
                                <td>${user.phonenum}</td>
                                <td>${user.email}</td>
                                <td>${user.departid==1?"管理":"其他"}</td>
                                <td title="${user.equid}"><a target="_blank" title="${user.equid}"
                                                             href="#"> ${user.equid} </a></td>
                                <td><fmt:formatDate value="${user.prebacktime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                <td>

                                    <button class="btn btn-primary btn-sm edit_btn">
                                        <span class="glyphicon glyphicon-pencil"><a style="color: whitesmoke"
                                                                                    href="${APP_PATH}/forward/toEdituserForward/${user.userid}">编辑</a></span>
                                    </button>&nbsp;&nbsp;
                                    <button class="btn btn-danger btn-sm delete_btn">
                                        <span class="glyphicon glyphicon-trash"><a class="deleteuser"
                                                                                   style="color: whitesmoke"
                                                                                   href="${APP_PATH}/service/deleteUser/${user.userid}"
                        ...
                        <th>
                            <div class="col-md-6">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <li class="active">
                                            <a href="${pageContext.request.contextPath}/service/userPageJump?pn=${pageInfo.firstPage}">首页</a>
                                        </li>
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/service/userPageJump?pn=${pageInfo.pageNum-1}"
                                                   aria-label="Previous">
                                        ...
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="num">
                                            ...
                                            <c:if test="${num != pageInfo.pageNum}">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/service/userPageJump?pn=${num}">${num}</a>
                                                </li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <li class="active">
                                            <a href="${pageContext.request.contextPath}/service/userPageJump?pn=${pageInfo.lastPage}">末页</a>
                                        </li>
