    ...
    <div class="main-wrap" style="background-image: url('/static/images/20.jpg');height: auto;width: auto;">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${APP_PATH}/forward/homeForward">首页</a><span class="crumb-step">&gt;</span><a
                    class="crumb-name" href="${APP_PATH}/forward/userForward">用户管理</a><span class="crumb-step">&gt;</span><span>编辑用户</span>
            </div>
        </div>
...
<%--                    <a href="#"><i class="glyphicon glyphicon-cloud"></i>作品评论</a>--%>
        ...
        <div class="result-wrap" style="margin-top: 100px">
            <div class="result-content">
                <form action="${APP_PATH}/service/updatequb" method="post" name="myform">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th width="120"><i class="require-red">*</i>编号：</th>
                            <td>
                                <input class="common-text required" type="text" name="equid" size="30"
                                       value="${equbs.equid}" readonly="readonly"/>
                            </td>
                        </tr>
                        <tr>
                            <th width="120"><i class="require-red">*</i>名字：</th>
                            <td>
                                <input class="common-text required" type="text" name="euqname" size="30"
                                       value="${equbs.euqname}"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" name="equkind" size="30"
                                       value="${equbs.equkind}" type="text"/>
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>型号：</th>
                            <td><input type="text" class="common-text required" name="type" size="30"
                                       value="${equbs.type}"/></td>
                        </tr>
<%--                        <tr>--%>
<%--                            <th><i class="require-red">*</i>购买时间：</th>--%>
<%--                            <td><input type="text" class="common-text required" name="buytime" size="30"--%>
<%--                                       value="${equbs.buytime}"/></td>--%>
<%--                        </tr>--%>
                        <tr>
                            <th><i class="require-red">*</i>所属部门：</th>
                            <td>
                                <input type="text" value="${equbs.departmentid==1?"管理部":"其他部"}" readonly="readonly" size="5">

                            <label><input type="radio" name="departmentid"  value="1">管理部</label>
                                <label><input type="radio" name="departmentid"  value="2">其他部</label></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>存储位置：</th>
                            <td><input type="text" class="common-text required" size="5" readonly="readonly"
                                       value="${equbs.position}"/>
